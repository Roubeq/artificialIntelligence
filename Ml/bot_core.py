...
class ChatBot:
    def __init__(self):
        ...
        # Загружаем классификатор интентов
        try:
    ...
    def process_message(self, message):
        ...
        # Получаем текущее состояние из dialog_manager
        ...
        # Если классификатор не сработал или уверенность низкая, используем старые паттерны
...
я уточню город в следующем сообщении."""
    ...
    def run(self):
        ...
        if self.intent_classifier:
            print("🤖 Используется ML классификатор интентов")
        else:
